...
"""
pytest -v -s fixtures/test_add.py::test_add_returns_valid_id --setup-show

The F and S in front of the fixture names indicate scope. F for function scope, and S for session scope. 
"""
